...
def check_for_win():
    ...
    # col_result = []  # [False, True, False]
    #
    # for c in range(size):
    #     current_result = []  # [True, True, True]
    #
    #     for r in range(size):
    #         current_result.append(board[r][c] == player_symbol)
    #
    #     col_result.append(all(current_result))
    #
    # col_win = any(col_result)
